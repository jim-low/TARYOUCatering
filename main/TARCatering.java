...
//             packageChoice = TARCatering.scan.nextInt();
...
//                     sizeChoice = TARCatering.scan.nextInt();
...
//            choice = TARCatering.scan.nextInt();
...
//                    Double addAmt = TARCatering.scan.nextDouble();

//                    //add with the current date.
//                    LocalDate dToAdd = LocalDate.now();

//                    System.out.print("\n\nEnter the Payment Method :");
//                    String addMethod = TARCatering.scan.nextLine() + TARCatering.scan.nextLine();
...
//                    String removeId = TARCatering.scan.nextLine() + TARCatering.scan.nextLine();
...
//                    String searchId = TARCatering.scan.nextLine() + TARCatering.scan.nextLine();
//                    while(payIterator.hasNext()){
//                        Payment pay = payIterator.next();
//                        date = dateFormat.format(pay.getPaymentDate());
